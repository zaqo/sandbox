class ChangeTechparamsToDecimals < ActiveRecord::Migration
  def change
	change_table :techparams do |t|
		t.remove  :waterpc, :waterl, :flour, :tempz,:temph1,:temph2,
		...
		t.decimal :vel90, :vel51, :waterpc, :waterl, :watert,:headt1,:headt2,
